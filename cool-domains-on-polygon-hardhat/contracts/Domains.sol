...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Hero Name Service", "HNS") {
        tld = _tld;
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Hero name service", "image": "data:image/svg+xml;base64,',
